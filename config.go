...
type Config struct {
	...
	Monitor struct { StartupDelaySec int `json:"startup_delay_seconds"`; CheckIntervalSec int `json:"health_check_interval_seconds"`; UnhealthyThreshold int `json:"unhealthy_threshold"` } `json:"monitor"`
